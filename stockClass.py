...
class Stock:
    ...
    # Add day of price and volume history to stock
    def add_data(self, dayData):
        self.DataList.append(dayData)


# DailyData class, stores the data necesarry to update stock
class DailyData:
