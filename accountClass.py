# Sebastian Janice - 4/16/2023 - CSE215

# Stock Class, displays key factors of stock

from stockClass import Stock

#Retirement Account - (Parent)
...
#Traditional Account - (Child Class)
class Traditional(Retirement_Account):
    def __init__(self, balance, number):
        super().__init__(balance, number) #parent class constructor
        self.Stock_List = []
